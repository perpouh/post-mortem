...
ActiveRecord::Schema.define(version: 2020_12_17_062403) do
  ...
  create_table "opinions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.integer "project_id"
